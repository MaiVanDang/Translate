...
const translations = {
    vi: {
        ...
        historyAutoDeleteNotice: 'Lịch sử dịch sẽ tự động xóa sau 30 phút.',
    ...
    ja: {
        ...
        historyAutoDeleteNotice: '翻訳履歴は30分後に自動的に削除されます。',
    ...
    en: {
        ...
        historyAutoDeleteNotice: 'Translation history will be automatically deleted after 30 minutes.',
